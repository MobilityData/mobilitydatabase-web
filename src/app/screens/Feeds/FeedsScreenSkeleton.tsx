      ...
      <ColoredContainer maxWidth='xl' sx={{ pt: 2 }}>
        ...
        >
          ...
          <Grid size={{ xs: 12, md: 2 }} sx={{ minWidth: '275px', pr: 2 }}>
            <Skeleton
              variant='text'
              sx={{ fontSize: '1.25rem', width: '80%', mb: 1 }}
            />
            {Array.from({ length: 5 }).map((_, i) => (
              <Skeleton
                key={i}
                variant='text'
                sx={{ fontSize: '1rem', width: '90%', mb: 0.5 }}
              />
            ))}
            <Skeleton
              variant='text'
              sx={{ fontSize: '1.25rem', width: '70%', mt: 2, mb: 1 }}
            />
            {Array.from({ length: 4 }).map((_, i) => (
              <Skeleton
                key={i}
                variant='text'
                sx={{ fontSize: '1rem', width: '85%', mb: 0.5 }}
              />
            ))}
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 10 }}>
            ...
            <Skeleton
              variant='text'
              sx={{ fontSize: '1rem', width: '200px', mb: 1 }}
            />
