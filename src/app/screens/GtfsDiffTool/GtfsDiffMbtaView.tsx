...
import mbtaDiff from './mbta-diff.json';
import mbtaBreakingChanges from './mbta-breaking.json';

export default function GtfsDiffMbtaView(): React.ReactElement {
  const diff = mbtaDiff as unknown as GtfsDiff;
  const breakingChanges = mbtaBreakingChanges as unknown as BreakingChangeReport;
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', py: 4, px: 2 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1, flexWrap: 'wrap' }}>
        ...
        <Chip label='MBTA' size='small' color='primary' variant='outlined' />
      </Box>
      <Typography color='text.secondary' sx={{ mb: 1 }}>
        Diff report for MBTA, comparing the July 15 and July 21 2026 static feeds. Upload your own
        feeds on the{' '}
