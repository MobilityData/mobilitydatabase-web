...
import cdpgReport2BreakingChanges from './cdpg-report-2-breaking-changes.json';

export default function GtfsDiffCdpgReport2View(): React.ReactElement {
  const diff = cdpgReport2Diff as unknown as GtfsDiff;
  const newReport = cdpgReport2ValidationReportNew as ValidationReport;
  const oldReport = cdpgReport2ValidationReportOld as ValidationReport;
  const breakingChanges = cdpgReport2BreakingChanges as unknown as BreakingChangeReport;
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', py: 4, px: 2 }}>
      ...
      <Typography color='text.secondary' sx={{ mb: 1 }}>
        ...
        2026-03-03 feed against the 2025-10-09 snapshot. Upload your own feeds on the{' '}
