                    ...
                    >
                      ...
                      {dataset.validation_report == undefined && (
                        <Button
                          ...
                          sx={{ mx: 2 }}
                          disableElevation
                          endIcon={<LaunchOutlined aria-hidden />}
                          aria-label={`${t('runValidationReportYourself')}${dataset.downloaded_at != null ? ` – ${new Date(dataset.downloaded_at).toDateString()}` : ''}`}
                      ...
                      {dataset.validation_report != null && (
                        <>
                          ...
                          >
                            <IconButton
                              color='primary'
                              aria-label={`${t('datasetHistoryTooltip.viewReport')}${dataset.downloaded_at != null ? ` – ${new Date(dataset.downloaded_at).toDateString()}` : ''}`}
                              size='medium'
                              href={`${dataset?.validation_report?.url_html}`}
                              target='_blank'
                              rel='noreferrer nofollow'
                          ...
                          >
                            <IconButton
                              color='primary'
                              aria-label={`${t('datasetHistoryTooltip.viewJsonReport')}${dataset.downloaded_at != null ? ` – ${new Date(dataset.downloaded_at).toDateString()}` : ''}`}
                              size='medium'
